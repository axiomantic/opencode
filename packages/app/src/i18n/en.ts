export const dict = {
  ...
  "dialog.rewind.title": "Rewind to message",
  "dialog.rewind.empty": "No messages to rewind to",
  "dialog.rewind.mode.title": "Choose rewind mode",
  "dialog.rewind.full.title": "Restore Everything",
  "dialog.rewind.full.description": "Revert code and hide messages from this point",
  "dialog.rewind.conversation.title": "Conversation Only",
  "dialog.rewind.conversation.description": "Hide messages but keep code changes",
  "dialog.rewind.code.title": "Code Only",
  "dialog.rewind.code.description": "Revert code but keep conversation visible",
  "dialog.rewind.summarize.title": "Summarize",
  "dialog.rewind.summarize.description": "Compress messages from here into a summary",
  "dialog.rewind.alreadyReverted.title": "Session Already Reverted",
  "dialog.rewind.alreadyReverted.description": "Restore the previous state first",
  "dialog.rewind.unrevert": "Restore All",

  "command.session.rewind": "Rewind session",
  "command.session.rewind.description": "Rewind to a previous message with options",
  ...
  "settings.mcp.description": "Manage Model Context Protocol servers that provide tools to the AI.",
  "settings.mcp.section.configured": "Configured Servers",
  "settings.mcp.empty": "No MCP servers configured",
  "settings.mcp.configNote": "To edit or remove servers, modify your opencode.json file.",
  "settings.mcp.action.add": "Add MCP Server",
  "settings.mcp.action.retry": "Retry",
  "settings.mcp.action.authenticate": "Authenticate",

  "dialog.addMcp.title": "Add MCP Server",
  "dialog.addMcp.type.local": "Local",
  "dialog.addMcp.type.local.description": "Run a local command",
  "dialog.addMcp.type.remote": "Remote",
  "dialog.addMcp.type.remote.description": "Connect to a URL",
  "dialog.addMcp.field.name": "Name",
  "dialog.addMcp.field.name.placeholder": "my-mcp-server",
  "dialog.addMcp.field.command": "Command",
  "dialog.addMcp.field.command.placeholder": "npx @modelcontextprotocol/server-filesystem",
  "dialog.addMcp.field.command.hint": "Enter the command to start the MCP server. Arguments can be space-separated.",
  "dialog.addMcp.field.url": "URL",
  "dialog.addMcp.field.url.placeholder": "https://mcp.example.com",
  "dialog.addMcp.field.url.hint": "Enter the URL of the remote MCP server.",
  "dialog.addMcp.action.add": "Add Server",
  "dialog.addMcp.error.invalidUrl": "URL must start with http:// or https://",
  "dialog.addMcp.error.nameRequired": "Name is required",
  "dialog.addMcp.error.commandRequired": "Command is required",
  "dialog.addMcp.error.urlRequired": "URL is required",
  "dialog.addMcp.toast.added.title": "MCP server added",

  "mcp.status.needs_client_registration": "needs client registration",
  "mcp.error.needs_client_registration": "This server requires a pre-registered OAuth client ID.",
